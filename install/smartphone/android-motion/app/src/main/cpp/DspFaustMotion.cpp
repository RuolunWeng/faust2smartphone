...
public:
    ...
    virtual void buildUserInterface(UI* ui_interface) {
        ...
        ui_interface->addCheckButton("brasG_frontOn", &fcheckbox43);
        ui_interface->addCheckButton("brasG_jardinOn", &fcheckbox42);
        ui_interface->addCheckButton("brasG_rearOn", &fcheckbox41);
        ui_interface->addCheckButton("brasG_upOn", &fcheckbox40);
        ...
        ui_interface->addHorizontalSlider("shape1", &fslider38, 1.0f, 0.0f, 1e+02f, 0.01f);
        ui_interface->addHorizontalSlider("shape2", &fslider39, 1.0f, 0.0f, 1e+02f, 0.01f);
        ui_interface->addHorizontalSlider("shape3", &fslider40, 1.0f, 0.0f, 1e+02f, 0.01f);
        ui_interface->addHorizontalSlider("shape4", &fslider41, 1.0f, 0.0f, 1e+02f, 0.01f);
        ui_interface->addHorizontalSlider("shape5", &fslider42, 1.0f, 0.0f, 1e+02f, 0.01f);
    ...
    virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
        ...
        for (int i=0; i<count; i++) {
            ...
            if (iSlow106 || iSlow115 || iSlow118 || iSlow120) {
            ...
            if (iSlow106) {
                ...
                fRec86[0] = fRec87[0];
                fTempPerm95 = (fSlow105 * fRec86[0]);
            }
            output37[i] = (FAUSTFLOAT)fTempPerm95;
            if (iSlow132 || iSlow134 || iSlow129 || iSlow136 || iSlow138 || iSlow140) {
                fTempPerm96 = (float)input0[i];
                fTempPerm97 = (float)input1[i];
            }
            if (iSlow132 || iSlow134 || iSlow129 || iSlow138) {
                fTempPerm98 = faustpower<2>(fTempPerm97);
            }
            if (iSlow132 || iSlow134 || iSlow129 || iSlow136 || iSlow138 || iSlow140) {
                fTempPerm99 = (float)input2[i];
            }
            if (iSlow129 || iSlow136 || iSlow138 || iSlow140) {
            ...
            if (iSlow132 || iSlow134 || iSlow136 || iSlow140) {
                fTempPerm102 = faustpower<2>(fTempPerm96);
            }
            if (iSlow136 || iSlow140) {
            ...
            if (iSlow136) {
                ...
                fTempPerm104 = (fSlow135 * fRec89[0]);
            }
            ...
            if (iSlow138) {
                ...
                fTempPerm105 = (fSlow137 * fRec90[0]);
            }
            ...
            if (iSlow140) {
                ...
                fTempPerm106 = (fSlow139 * fRec91[0]);
            }
            output41[i] = (FAUSTFLOAT)fTempPerm106;
            if (iSlow132 || iSlow134) {
            ...
            if (iSlow134) {
                ...
                fTempPerm109 = (fSlow133 * fRec93[0]);
            }
