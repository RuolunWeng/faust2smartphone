...
public:
    ...
    virtual void buildUserInterface(UI* ui_interface) {
        ...
        ui_interface->declare(&fcheckbox26, "27", "");
        ui_interface->declare(&fcheckbox26, "motionName", "totalaccel");
        ui_interface->addCheckButton("totalaccelOn", &fcheckbox26);
        ...
        ui_interface->declare(&fcheckbox45, "41", "");
        ui_interface->declare(&fcheckbox45, "motionName", "brasG_front");
        ui_interface->addCheckButton("brasG_frontOn", &fcheckbox45);
        ...
        ui_interface->declare(&fcheckbox58, "45", "");
        ui_interface->declare(&fcheckbox58, "motionName", "pieds_rear");
        ui_interface->addCheckButton("pieds_rearOn", &fcheckbox58);
        ui_interface->declare(&fcheckbox54, "46", "");
        ui_interface->declare(&fcheckbox54, "motionName", "pieds_jardin");
        ui_interface->addCheckButton("pieds_jardinOn", &fcheckbox54);
        ui_interface->declare(&fcheckbox55, "47", "");
        ui_interface->declare(&fcheckbox55, "motionName", "pieds_front");
        ui_interface->addCheckButton("pieds_frontOn", &fcheckbox55);
        ui_interface->declare(&fcheckbox56, "48", "");
        ui_interface->declare(&fcheckbox56, "motionName", "pieds_down");
        ui_interface->addCheckButton("pieds_downOn", &fcheckbox56);
        ui_interface->declare(&fcheckbox57, "49", "");
        ui_interface->declare(&fcheckbox57, "motionName", "pieds_up");
        ui_interface->addCheckButton("pieds_upOn", &fcheckbox57);
        ...
        ui_interface->declare(&fcheckbox81, "63", "");
        ui_interface->declare(&fcheckbox81, "motionName", "tete_rear");
        ui_interface->addCheckButton("tete_rearOn", &fcheckbox81);
        ...
        ui_interface->declare(&fcheckbox77, "65", "");
        ui_interface->declare(&fcheckbox77, "motionName", "tete_front");
        ui_interface->addCheckButton("tete_frontOn", &fcheckbox77);
        ui_interface->declare(&fcheckbox78, "66", "");
        ui_interface->declare(&fcheckbox78, "motionName", "tete_down");
        ui_interface->addCheckButton("tete_downOn", &fcheckbox78);
        ui_interface->declare(&fcheckbox79, "67", "");
        ui_interface->declare(&fcheckbox79, "motionName", "tete_up");
        ui_interface->addCheckButton("tete_upOn", &fcheckbox79);
        ...
        ui_interface->declare(&fcheckbox89, "70", "");
        ui_interface->declare(&fcheckbox89, "motionName", "ventre_jardin");
        ui_interface->addCheckButton("ventre_jardinOn", &fcheckbox89);
        ui_interface->declare(&fcheckbox90, "71", "");
        ui_interface->declare(&fcheckbox90, "motionName", "ventre_front");
        ui_interface->addCheckButton("ventre_frontOn", &fcheckbox90);
        ui_interface->declare(&fcheckbox86, "72", "");
        ui_interface->declare(&fcheckbox86, "motionName", "ventre_down");
        ui_interface->addCheckButton("ventre_downOn", &fcheckbox86);
        ui_interface->declare(&fcheckbox87, "73", "");
        ui_interface->declare(&fcheckbox87, "motionName", "ventre_up");
        ui_interface->addCheckButton("ventre_upOn", &fcheckbox87);
    ...
    virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
        ...
        for (int i=0; i<count; i++) {
            ...
            if (iSlow99 || iSlow92 || iSlow102 || iSlow104) {
                fVec25[0] = fSlow100;
            ...
            if (iSlow106 || iSlow92 || iSlow109 || iSlow111) {
                fVec26[0] = fSlow107;
            ...
            if (iSlow92) {
                ...
                fRec63[0] = fRec64[0];
                fTempPerm77 = (fSlow91 * fRec63[0]);
            }
            output27[i] = (FAUSTFLOAT)fTempPerm77;
            if (iSlow117 || iSlow119 || iSlow113 || iSlow121) {
            ...
            if (iSlow143 || iSlow140 || iSlow145 || iSlow147 || iSlow149 || iSlow151 || iSlow153) {
                fTempPerm108 = (float)input0[i];
            }
            if (iSlow143 || iSlow140 || iSlow145 || iSlow147 || iSlow149 || iSlow151 || iSlow155) {
                fTempPerm109 = (float)input1[i];
            }
            if (iSlow140 || iSlow147 || iSlow149 || iSlow151) {
                fTempPerm110 = faustpower<2>(fTempPerm109);
            }
            if (iSlow143 || iSlow140 || iSlow145 || iSlow147 || iSlow149 || iSlow151 || iSlow157) {
                fTempPerm111 = (float)input2[i];
            }
            if (iSlow143 || iSlow140 || iSlow145 || iSlow147) {
            ...
            if (iSlow143 || iSlow145 || iSlow149 || iSlow151) {
                fTempPerm114 = faustpower<2>(fTempPerm108);
            }
            if (iSlow143 || iSlow145) {
            ...
            if (iSlow145) {
                ...
                fTempPerm116 = (fSlow144 * fRec89[0]);
            }
            ...
            if (iSlow147) {
                ...
                fTempPerm117 = (fSlow146 * fRec90[0]);
            }
            ...
            if (iSlow143) {
                ...
                fTempPerm118 = (fSlow142 * fRec91[0]);
            }
            ...
            if (iSlow166 || iSlow168 || iSlow170 || iSlow172 || iSlow164 || iSlow174) {
                fTempPerm122 = (float)input3[i];
                fTempPerm123 = (float)input4[i];
            }
            if (iSlow166 || iSlow170 || iSlow172 || iSlow164) {
                fTempPerm124 = faustpower<2>(fTempPerm123);
            }
            if (iSlow166 || iSlow168 || iSlow170 || iSlow172 || iSlow164 || iSlow174) {
                fTempPerm125 = (float)input5[i];
            }
            if (iSlow166 || iSlow168 || iSlow164 || iSlow174) {
            ...
            if (iSlow168 || iSlow170 || iSlow172 || iSlow174) {
                fTempPerm128 = faustpower<2>(fTempPerm122);
            }
            if (iSlow168 || iSlow174) {
            ...
            if (iSlow174) {
                ...
                fTempPerm130 = (fSlow173 * fRec95[0]);
            }
            ...
            if (iSlow166) {
                ...
                fTempPerm131 = (fSlow165 * fRec96[0]);
            }
            ...
            if (iSlow168) {
                ...
                fTempPerm132 = (fSlow167 * fRec97[0]);
            }
            output47[i] = (FAUSTFLOAT)fTempPerm132;
            if (iSlow170 || iSlow172) {
            ...
            if (iSlow170) {
                ...
                fTempPerm134 = (fSlow169 * fRec98[0]);
            }
            ...
            if (iSlow172) {
                ...
                fTempPerm135 = (fSlow171 * fRec99[0]);
            }
            ...
            if (iSlow200 || iSlow198 || iSlow202 || iSlow204 || iSlow206 || iSlow208) {
                fTempPerm150 = (float)input9[i];
                fTempPerm151 = (float)input10[i];
            }
            if (iSlow200 || iSlow198 || iSlow204 || iSlow208) {
                fTempPerm152 = faustpower<2>(fTempPerm151);
            }
            if (iSlow200 || iSlow198 || iSlow202 || iSlow204 || iSlow206 || iSlow208) {
                fTempPerm153 = (float)input11[i];
            }
            if (iSlow198 || iSlow202 || iSlow204 || iSlow206) {
            ...
            if (iSlow200 || iSlow202 || iSlow206 || iSlow208) {
            ...
            if (iSlow202) {
                ...
                fTempPerm158 = (fSlow201 * fRec107[0]);
            }
            ...
            if (iSlow204) {
                ...
                fTempPerm159 = (fSlow203 * fRec108[0]);
            }
            ...
            if (iSlow206) {
                ...
                fTempPerm160 = (fSlow205 * fRec109[0]);
            }
            output59[i] = (FAUSTFLOAT)fTempPerm160;
            if (iSlow200 || iSlow208) {
            ...
            if (iSlow212 || iSlow214 || iSlow216 || iSlow218 || iSlow220 || iSlow222 || iSlow210) {
                fTempPerm164 = (float)input12[i];
            }
            if (iSlow212 || iSlow214 || iSlow216 || iSlow218 || iSlow220 || iSlow224 || iSlow210) {
                fTempPerm165 = (float)input13[i];
            }
            if (iSlow214 || iSlow216 || iSlow218 || iSlow210) {
                fTempPerm166 = faustpower<2>(fTempPerm165);
            }
            if (iSlow212 || iSlow214 || iSlow216 || iSlow218 || iSlow220 || iSlow226 || iSlow210) {
                fTempPerm167 = (float)input14[i];
            }
            if (iSlow212 || iSlow218 || iSlow220 || iSlow210) {
            ...
            if (iSlow220) {
                ...
                fTempPerm172 = (fSlow219 * fRec113[0]);
            }
            ...
            if (iSlow212) {
                ...
                fTempPerm174 = (fSlow211 * fRec115[0]);
            }
            ...
            if (iSlow214) {
                ...
                fTempPerm176 = (fSlow213 * fRec116[0]);
            }
            ...
            if (iSlow216) {
                ...
                fTempPerm177 = (fSlow215 * fRec117[0]);
            }
            ...
            if (iSlow228 || iSlow230 || iSlow232 || iSlow236) {
                fTempPerm180 = faustpower<2>(fTempPerm179);
            }
            if (iSlow228 || iSlow230 || iSlow232 || iSlow234 || iSlow236 || iSlow238) {
                fTempPerm181 = (float)input17[i];
            }
            if (iSlow228 || iSlow234 || iSlow236 || iSlow238) {
            ...
            if (iSlow230 || iSlow232 || iSlow234 || iSlow238) {
                fTempPerm184 = faustpower<2>(fTempPerm178);
            }
            if (iSlow234 || iSlow238) {
            ...
            if (iSlow234) {
                ...
                fTempPerm186 = (fSlow233 * fRec119[0]);
            }
            ...
            if (iSlow236) {
                ...
                fTempPerm187 = (fSlow235 * fRec120[0]);
            }
            ...
            if (iSlow238) {
                ...
                fTempPerm188 = (fSlow237 * fRec121[0]);
            }
            ...
            if (iSlow230) {
                ...
                fTempPerm190 = (fSlow229 * fRec122[0]);
            }
            ...
            if (iSlow232) {
                ...
                fTempPerm191 = (fSlow231 * fRec123[0]);
            }
            ...
            if (iSlow55) {
                fTempPerm194 = (fSlow54 * min((float)1, max((float)0, (0 - (0.5f * (fTempPerm40 - (fTempPerm34 + 1.0f)))))));
            }
            ...
            if (iSlow53) {
                fTempPerm197 = (fSlow52 * min((float)1, max((float)0, (1.0f - (fTempPerm34 + fTempPerm40)))));
            }
