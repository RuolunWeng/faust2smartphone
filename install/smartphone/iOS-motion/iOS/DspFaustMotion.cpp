...
class mydsp2 : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalBargraph("brasD_cours", &fbargraph56, 0.0f, 1.0f);
		ui_interface->addCheckButton("brasD_coursOn", &fcheckbox56);
		...
		ui_interface->addHorizontalBargraph("brasG_cours", &fbargraph38, 0.0f, 1.0f);
		ui_interface->addCheckButton("brasG_coursOn", &fcheckbox38);
		...
		ui_interface->addHorizontalBargraph("dos_cours", &fbargraph50, 0.0f, 1.0f);
		ui_interface->addCheckButton("dos_coursOn", &fcheckbox50);
		...
		ui_interface->addHorizontalBargraph("pieds_cours", &fbargraph44, 0.0f, 1.0f);
		ui_interface->addCheckButton("pieds_coursOn", &fcheckbox44);
		...
		ui_interface->addHorizontalBargraph("tete_cours", &fbargraph62, 0.0f, 1.0f);
		ui_interface->addCheckButton("tete_coursOn", &fcheckbox62);
		...
		ui_interface->addHorizontalBargraph("ventre_cours", &fbargraph68, 0.0f, 1.0f);
		ui_interface->addCheckButton("ventre_coursOn", &fcheckbox68);
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow142 = (fConst8 * max(0.0f, (1 - (fSlow139 * sqrtf((faustpower<2>((fSlow132 + -1.0f)) + fSlow141))))));
		...
		float 	fSlow172 = (fConst8 * max(0.0f, (1 - (fSlow139 * sqrtf((faustpower<2>((fSlow163 + -1.0f)) + fSlow171))))));
		...
		float 	fSlow198 = (fConst8 * max(0.0f, (1 - (fSlow139 * sqrtf((faustpower<2>((fSlow189 + -1.0f)) + fSlow197))))));
		...
		float 	fSlow224 = (fConst8 * max(0.0f, (1 - (fSlow139 * sqrtf((faustpower<2>((fSlow215 + -1.0f)) + fSlow223))))));
		...
		float 	fSlow250 = (fConst8 * max(0.0f, (1 - (fSlow139 * sqrtf((faustpower<2>((fSlow241 + -1.0f)) + fSlow249))))));
		...
		float 	fSlow276 = (fConst8 * max(0.0f, (1 - (fSlow139 * sqrtf((faustpower<2>((fSlow267 + -1.0f)) + fSlow275))))));
