...
public class DspFaust {
  ...
  protected static long swigRelease(DspFaust obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public float getParamStep(int p) {
    return dsp_faustJNI.DspFaust_getParamStep(swigCPtr, this, p);
  }
  ...
  public String getParamShortName(int p) {
    return dsp_faustJNI.DspFaust_getParamShortName(swigCPtr, this, p);
  }
  ...
  public boolean getMIDIIsOn() {
    return dsp_faustJNI.DspFaust_getMIDIIsOn(swigCPtr, this);
  }
