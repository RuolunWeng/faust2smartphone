...
SWIGEXPORT void JNICALL Java_com_DspFaust_dsp_1faustJNI_DspFaust_1render(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  DspFaust *arg1 = (DspFaust *) 0 ;
...
SWIGEXPORT void JNICALL Java_com_DspFaust_dsp_1faustJNI_DspFaust_1sendInput(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2, jfloat jarg3) {
  DspFaust *arg1 = (DspFaust *) 0 ;
  int arg2 ;
  float arg3 ;
...
SWIGEXPORT jfloat JNICALL Java_com_DspFaust_dsp_1faustJNI_DspFaust_1getOutput(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  jfloat jresult = 0 ;
  DspFaust *arg1 = (DspFaust *) 0 ;
  int arg2 ;
  float result;
...
SWIGEXPORT jint JNICALL Java_com_DspFaust_dsp_1faustJNI_DspFaust_1getOutputChannelNum(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  DspFaust *arg1 = (DspFaust *) 0 ;
  int result;
...
SWIGEXPORT jint JNICALL Java_com_DspFaust_dsp_1faustJNI_DspFaust_1getInputChannelNum(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  DspFaust *arg1 = (DspFaust *) 0 ;
  int result;
