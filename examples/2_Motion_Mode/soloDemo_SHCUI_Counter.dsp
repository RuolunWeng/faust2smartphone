declare name 		"SoloDemo_SHCUI:trigCounter";
declare version 	"4.0";
...
cueNum = nentry("Trig_Event [SHCUI:Master trigCounter 0 0 100 50 255 255 0 255]",0,0,3,1);
touchGate = checkbox("OnOff [SHCUI:Master checkbox 0 50 50 50 0 255 0 255]");
volume = hslider("MasterVol [SHCUI:Master hslider 50 50 50 50 0 255 255 255]",0,0,1,0.01);
